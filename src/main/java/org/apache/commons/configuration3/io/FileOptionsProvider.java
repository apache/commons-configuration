...
public interface FileOptionsProvider {
    ...
    /**
     * Key used to identify the proxy host to connect through. The value associated with this key is a String identifying
     * the host name of the proxy.
     */
    String PROXY_HOST = "proxyHost";

    /**
     * Key used to identify the proxy port to connect through. The value associated with this key is an Integer identifying
     * the port on the proxy.
     */
    String PROXY_PORT = "proxyPort";

    /**
     * Key used to identify the maximum number of connections allowed to a single host. The value associated with this key
     * is an Integer identifying the maximum number of connections allowed to a single host.
     */
    String MAX_HOST_CONNECTIONS = "maxHostConnections";

    /**
     * Key used to identify the maximum number of connections allowed to all hosts. The value associated with this key is an
     * Integer identifying the maximum number of connections allowed to all hosts.
     */
