...
import org.apache.commons.configuration3.convert.PropertyConverter;
...
public interface ImmutableConfiguration {
     ...
     * @throws org.apache.commons.configuration3.ex.ConversionException if the value is not compatible with the requested
     *         type
     * @since 2.0
     */
     ...
     *
     * @throws org.apache.commons.configuration3.ex.ConversionException is thrown if the key maps to an object that is not
     ...
     * @throws org.apache.commons.configuration3.ex.ConversionException is thrown if the key maps to an object that is not a
     *         Boolean.
     */
     ...
     * @throws org.apache.commons.configuration3.ex.ConversionException if the conversion is not possible
     * @since 2.0
     */
