 ...
 * </p>
 * <p>
 * {@link org.apache.commons.configuration3.AbstractConfiguration AbstractConfiguration} supports list delimiters in
 * property values. If such a delimiter is found, the value actually contains multiple values and has to be split. This
 * is useful for instance for {@link org.apache.commons.configuration3.PropertiesConfiguration PropertiesConfiguration}:
