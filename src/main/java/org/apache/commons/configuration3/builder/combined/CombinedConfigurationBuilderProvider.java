...
public class CombinedConfigurationBuilderProvider extends BaseConfigurationBuilderProvider {
    ...
    private static final String BUILDER_CLASS = "org.apache.commons.configuration3.builder.combined.CombinedConfigurationBuilder";

    /** Constant for the name of the supported reloading builder class. */
    private static final String RELOADING_BUILDER_CLASS = "org.apache.commons.configuration3.builder.combined.ReloadingCombinedConfigurationBuilder";

    /** Constant for the name of the supported configuration class. */
    private static final String CONFIGURATION_CLASS = "org.apache.commons.configuration3.CombinedConfiguration";

    /** Constant for the combined configuration builder parameters class. */
    private static final String COMBINED_PARAMS = "org.apache.commons.configuration3.builder.combined.CombinedBuilderParametersImpl";
