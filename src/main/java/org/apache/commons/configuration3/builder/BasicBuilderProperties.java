 ...
 */
package org.apache.commons.configuration3.builder;
...
import org.apache.commons.configuration3.convert.ConversionHandler;
...
import org.apache.commons.configuration3.io.ConfigurationLogger;
import org.apache.commons.configuration3.sync.Synchronizer;

/**
 * <p>
 * Definition of a properties interface for basic parameters which are supported by all {@link ConfigurationBuilder}
 * implementations derived from {@link BasicConfigurationBuilder}.
 * </p>
 * <p>
 * This interface defines the single properties supported by a parameters object. Properties can be set using a fluent
 * API making it convenient for client code to specify concrete property values in a single statement.
 * </p>
 * <p>
...
public interface BasicBuilderProperties<T> {
     ...
     * defined by this interface. By setting an alternative {@code BeanHelper} the process of creating configuration
     * instances via reflection can be adapted. (Some specialized configuration builder implementations also use a
     * {@code BeanHelper} to create complex helper objects during construction of their result object.
     * {@code CombinedConfigurationBuilder} for instance supports a complex configuration definition format which may
    ...
    /**
     * Sets the {@code ConversionHandler} object for this configuration. This object is responsible for all data type
    ...
    /**
     * Adds additional default {@code Lookup} objects (i.e. lookups which are not associated with a specific prefix) to this
    ...
    /**
     * Sets the {@code ConfigurationInterpolator} to be used for this configuration. Using this method a custom
     ...
     * {@link org.apache.commons.configuration3.AbstractConfiguration AbstractConfiguration} does not allow setting this
    ...
    /**
     * Sets the parent {@code ConfigurationInterpolator} for this configuration's {@code ConfigurationInterpolator}. Setting
    ...
    /**
     * Sets additional {@code Lookup} objects for specific prefixes for this configuration object. All {@code Lookup}
     * objects contained in the given map are added to the configuration's {@code ConfigurationInterpolator}. Note: This
    ...
    /**
     * Sets the {@code Synchronizer} object for this configuration. This object is used to protect this configuration
