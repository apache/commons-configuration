 ...
 */
package org.apache.commons.configuration3.builder.combined;
...
import org.apache.commons.configuration3.CombinedConfiguration;
import org.apache.commons.configuration3.Configuration;
import org.apache.commons.configuration3.ConfigurationLookup;
import org.apache.commons.configuration3.HierarchicalConfiguration;
import org.apache.commons.configuration3.SystemConfiguration;
import org.apache.commons.configuration3.XMLConfiguration;
import org.apache.commons.configuration3.beanutils.BeanDeclaration;
import org.apache.commons.configuration3.beanutils.BeanHelper;
import org.apache.commons.configuration3.beanutils.CombinedBeanDeclaration;
import org.apache.commons.configuration3.beanutils.XMLBeanDeclaration;
import org.apache.commons.configuration3.builder.BasicBuilderParameters;
import org.apache.commons.configuration3.builder.BasicConfigurationBuilder;
import org.apache.commons.configuration3.builder.BuilderParameters;
import org.apache.commons.configuration3.builder.ConfigurationBuilder;
import org.apache.commons.configuration3.builder.ConfigurationBuilderEvent;
import org.apache.commons.configuration3.builder.FileBasedBuilderParametersImpl;
import org.apache.commons.configuration3.builder.FileBasedBuilderProperties;
import org.apache.commons.configuration3.builder.FileBasedConfigurationBuilder;
import org.apache.commons.configuration3.builder.XMLBuilderParametersImpl;
import org.apache.commons.configuration3.builder.XMLBuilderProperties;
import org.apache.commons.configuration3.event.EventListener;
import org.apache.commons.configuration3.ex.ConfigurationException;
import org.apache.commons.configuration3.interpol.ConfigurationInterpolator;
import org.apache.commons.configuration3.interpol.Lookup;
import org.apache.commons.configuration3.io.FileSystem;
import org.apache.commons.configuration3.resolver.CatalogResolver;
import org.apache.commons.configuration3.tree.DefaultExpressionEngineSymbols;
import org.apache.commons.configuration3.tree.OverrideCombiner;
import org.apache.commons.configuration3.tree.UnionCombiner;
 ...
 * (namely {@link org.apache.commons.configuration3.beanutils.XMLBeanDeclaration XMLBeanDeclaration} will be used to
...
public class CombinedConfigurationBuilder extends BasicConfigurationBuilder<CombinedConfiguration> {
    ...
    private static final String BASIC_BUILDER = "org.apache.commons.configuration3.builder.BasicConfigurationBuilder";

    /** Constant for the file-based configuration builder class. */
    private static final String FILE_BUILDER = "org.apache.commons.configuration3.builder.FileBasedConfigurationBuilder";

    /** Constant for the reloading file-based configuration builder class. */
    private static final String RELOADING_BUILDER = "org.apache.commons.configuration3.builder.ReloadingFileBasedConfigurationBuilder";

    /** Constant for the name of the file-based builder parameters class. */
    private static final String FILE_PARAMS = "org.apache.commons.configuration3.builder.FileBasedBuilderParametersImpl";
    ...
    private static final ConfigurationBuilderProvider PROPERTIES_PROVIDER = new FileExtensionConfigurationBuilderProvider(FILE_BUILDER, RELOADING_BUILDER,
        "org.apache.commons.configuration3.XMLPropertiesConfiguration", "org.apache.commons.configuration3.PropertiesConfiguration", EXT_XML,
    ...
    private static final ConfigurationBuilderProvider XML_PROVIDER = new BaseConfigurationBuilderProvider(FILE_BUILDER, RELOADING_BUILDER,
        "org.apache.commons.configuration3.XMLConfiguration", Collections.singletonList("org.apache.commons.configuration3.builder.XMLBuilderParametersImpl"));
    ...
    private static final BaseConfigurationBuilderProvider JNDI_PROVIDER = new BaseConfigurationBuilderProvider(BASIC_BUILDER, null,
        "org.apache.commons.configuration3.JNDIConfiguration",
        Collections.singletonList("org.apache.commons.configuration3.builder.JndiBuilderParametersImpl"));
    ...
    private static final BaseConfigurationBuilderProvider SYSTEM_PROVIDER = new BaseConfigurationBuilderProvider(BASIC_BUILDER, null,
        "org.apache.commons.configuration3.SystemConfiguration", Collections.singletonList("org.apache.commons.configuration3.builder.BasicBuilderParameters"));
    ...
    private static final BaseConfigurationBuilderProvider INI_PROVIDER = new BaseConfigurationBuilderProvider(FILE_BUILDER, RELOADING_BUILDER,
        "org.apache.commons.configuration3.INIConfiguration", Collections.singletonList(FILE_PARAMS));
    ...
    private static final BaseConfigurationBuilderProvider ENV_PROVIDER = new BaseConfigurationBuilderProvider(BASIC_BUILDER, null,
        "org.apache.commons.configuration3.EnvironmentConfiguration",
        Collections.singletonList("org.apache.commons.configuration3.builder.BasicBuilderParameters"));
    ...
    private static final BaseConfigurationBuilderProvider PLIST_PROVIDER = new FileExtensionConfigurationBuilderProvider(FILE_BUILDER, RELOADING_BUILDER,
        "org.apache.commons.configuration3.plist.XMLPropertyListConfiguration", "org.apache.commons.configuration3.plist.PropertyListConfiguration", EXT_XML,
        Collections.singletonList(FILE_PARAMS));
    ...
    private static final MultiFileConfigurationBuilderProvider MULTI_XML_PROVIDER = new MultiFileConfigurationBuilderProvider(
        "org.apache.commons.configuration3.XMLConfiguration", "org.apache.commons.configuration3.builder.XMLBuilderParametersImpl");
    ...
    /**
     * Executes the {@link org.apache.commons.configuration3.builder.DefaultParametersManager DefaultParametersManager}
     ...
     * @throws org.apache.commons.configuration3.ex.ConfigurationRuntimeException if an error occurs when copying properties
     */
